...
local function ScaleW(x) return x * (ScrW() / REF_W) end
local function ScaleH(y) return y * (ScrH() / REF_H) end
...
function HUD()
    ...
    draw.RoundedBox(
        ...
        ScaleW(10),
        screenHeight - ScaleH(50),
        math.Clamp(client:Health(), 0, 100) * ScaleW(2.25),
        ScaleH(15),
        Color(255, 0, 0, 255)
    )
