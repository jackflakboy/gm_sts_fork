...
function HUD()
	...
	if client:Alive() == false then -- vscode is really unhappy about !client:Alive(), is this how you negate in lua?
		return
	end
...
--Research/Score/Team
	...
	--Mobstuff
	if client:GetNWInt("pickup") == 0 then -- this looks really goofy but "pickup" might not always be equal to 0 or 1, which is the only reason i can imagine he wrote it this way
		--nothing
	else
