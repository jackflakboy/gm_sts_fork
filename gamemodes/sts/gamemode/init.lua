...
cvars.AddChangeCallback(
    "sts_random_teams",
    function(convarName, valueOld, valueNew)
        print("TODO: Create team door and open and close it")
    end
)

cvars.AddChangeCallback(
    "sts_force_bonus_rounds",
    function(convarName, valueOld, valueNew)
            ...
            if npcClass == "npc_poisonzombie" then
                timer.Simple(
                    ...
                    function()
                        ...
                        timer.Create(
                            "CheckForHeadcrabs" .. ent:EntIndex(),
                            0.1,
                            600,
                            function()
